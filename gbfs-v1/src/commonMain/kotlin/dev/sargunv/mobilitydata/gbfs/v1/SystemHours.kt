...
public data class SystemHours(
     ...
     *
     * The array MUST contain a minimum of one object identifying hours for every day of the week or
     * a maximum of two for each day of the week (one for each user type).
     */
