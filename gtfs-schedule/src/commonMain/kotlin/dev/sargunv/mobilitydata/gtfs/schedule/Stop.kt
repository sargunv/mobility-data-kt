...
private constructor(
    ...
    public companion object {
        /**
         * The stop/platform cannot be directly accessed from the street network. It must be
         * accessed from a station entrance if there is one defined for the station, otherwise the
         * station itself. If there are pathways defined for the station, they must be used to
         * access the stop/platform.
         */
