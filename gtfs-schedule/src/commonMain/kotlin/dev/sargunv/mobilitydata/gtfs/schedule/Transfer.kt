...
public data class Transfer(
    /**
     * Identifies a stop or station where a connection between routes begins. If this field refers
     * to a station, the transfer rule applies to all its child stops.
     */
    @SerialName("from_stop_id") public val fromStopId: String? = null,

    /**
     * Identifies a stop or station where a connection between routes ends. If this field refers to
     * a station, the transfer rule applies to all child stops.
     */
    ...
    /**
     * Identifies a trip where a connection between routes begins. If defined, the transfer will
     * apply to the arriving trip for the given from_stop_id.
     */
...
private constructor(
    ...
    public companion object {
        ...
        /**
         * Timed transfer point between two routes. The departing vehicle is expected to wait for
         * the arriving one and leave sufficient time for a rider to transfer between routes.
         */
        ...
        /**
         * In-seat transfers are not allowed between sequential trips. The passenger must alight
         * from the vehicle and re-board.
         */
