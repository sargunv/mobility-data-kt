...
public data class StopTime(
    ...
    /**
     * Identifies the serviced location group that indicates groups of stops where riders may
     * request pickup or drop off.
     */
    ...
    public val endPickupDropOffWindow: ServiceTime? = null,
    ...
    public val continuousDropOff: ContinuousPickupDropOff? = null,
