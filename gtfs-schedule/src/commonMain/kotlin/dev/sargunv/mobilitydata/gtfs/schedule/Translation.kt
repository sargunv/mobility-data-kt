...
public data class Translation(
    ...
    /**
     * Defines the record that corresponds to the field to be translated. The value in record_id
     * must be the first or only field of the table's primary key.
     */
    @SerialName("record_id") public val recordId: String? = null,

    /**
     * Helps the record that contains the field to be translated when the table doesn't have a
     * unique ID. The value in record_sub_id is the second field of the table's primary key.
     */
