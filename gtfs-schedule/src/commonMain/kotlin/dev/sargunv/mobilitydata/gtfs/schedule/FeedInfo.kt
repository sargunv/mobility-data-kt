...
public data class FeedInfo(
    ...
    /**
     * The dataset provides complete and reliable schedule information for service in the period
     ...
     * can display this value to help dataset publishers determine whether the latest dataset has
     * been incorporated.
     */
