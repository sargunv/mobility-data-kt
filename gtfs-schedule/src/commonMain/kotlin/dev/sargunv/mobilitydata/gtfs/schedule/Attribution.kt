...
public data class Attribution(
     ...
     *
     * If one agency_id, route_id, or trip_id attribution is defined, the other ones must be empty.
     * If none of them is specified, the attribution will apply to the whole dataset.
     */
