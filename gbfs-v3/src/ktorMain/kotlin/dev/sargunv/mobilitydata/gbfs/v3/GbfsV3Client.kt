...
/**
 * Creates a [GbfsV3Client] with a specific HTTP client engine.
 *
 * @param engineFactory The Ktor HTTP client engine factory to use
 * @param block Configuration block for the HTTP client
 * @return A configured GBFS v3 client instance
 */
public fun <T : HttpClientEngineConfig> GbfsV3Client(
...
public class GbfsV3Client internal constructor(private val httpClient: HttpClient) : AutoCloseable {
  ...
  /**
   * Creates a [GbfsV3Client] with the default HTTP client engine.
   *
   * @param block Configuration block for the HTTP client
   */
  public constructor(
