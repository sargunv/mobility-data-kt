...
public data class Station(
     ...
     * unavailable, for each type of vehicle that may dock at this station. The total number of
     * docks from each of these objects SHOULD add up to match the value specified in the capacity
     * field.
     */
     ...
     * is_virtual_station field) for each vehicle type that can be returned to this station. The
     * total number of vehicles from each of these objects SHOULD add up to match the value
     * specified in the capacity field.
     */
