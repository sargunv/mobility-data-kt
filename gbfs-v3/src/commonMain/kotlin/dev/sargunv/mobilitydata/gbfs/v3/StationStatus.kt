...
public data class StationStatusEntry(
     ...
     * If is_renting = false, this is the number of vehicles that would be available for rent if the
     * station were set to allow rentals.
     */
    @SerialName("num_vehicles_available") public val numVehiclesAvailable: Int,
     ...
     * each of these objects SHOULD add up to match the value specified in num_vehicles_available.
     */
    @SerialName("vehicle_types_available")
    public val vehicleTypesAvailable: List<CountBySingleVehicleType>? = null,
     ...
     * field.
     */
    @SerialName("num_vehicles_disabled") public val numVehiclesDisabled: Int? = null,

    /**
     * Number of functional docks physically at the station that are able to accept vehicles for
     * return.
     *
     * REQUIRED except for stations that have unlimited docking capacity. If is_returning = true,
     * this is the number of docks that are currently available to accept vehicle returns. If
     * is_returning = false, this is the number of docks that would be available if the station were
     * set to allow returns.
     */
     ...
     *
     * REQUIRED in feeds where certain docks are only able to accept certain vehicle types. The
     * total number of docks from each of these objects SHOULD add up to match num_docks_available.
     */
    @SerialName("vehicle_docks_available")
    public val vehicleDocksAvailable: List<CountByMultipleVehicleTypes>? = null,
     ...
     *
     * If the station is temporarily taken out of service and not allowing rentals, this field MUST
     * be set to false.
     */
     ...
     *
     * If the station is temporarily taken out of service and not allowing vehicle returns, this
...
@Serializable
public data class CountBySingleVehicleType(
...
@Serializable
public data class CountByMultipleVehicleTypes(
    /**
