...
public data class PricingPlan(
     ...
     *
     * This pricing is in ISO 4217 code (for example, CAD for Canadian dollars, EUR for euros, or
     ...
     *
     * In case of non-rate price, this field is the total price. In case of rate price, this field
     * is the base price that is charged only once per trip (typically the price for unlocking) in
     ...
     * If this array is not provided, there are no variable costs based on distance.
     */
     ...
     *
     * Total cost is the addition of price and all segments in per_km_pricing and per_min_pricing.
     * If this array is not provided, there are no variable costs based on time.
     */
