 ...
 *
 * REQUIRED of systems that include information about vehicle types in the vehicle_status.json file.
 * This file SHOULD be published by systems offering multiple vehicle types for rental.
 */
@Serializable
...
public data class VehicleType(
     ...
     */
    @SerialName("eco_labels") public val ecoLabels: List<EcoLabel>? = null,
     ...
     */
    @SerialName("vehicle_accessories")
    public val vehicleAccessories: List<VehicleAccessory>? = null,
    ...
    public val make: LocalizedText? = null,
...
public value class VehiclePropulsionType(
    ...
    public companion object {
        ...
        /**
         * Provides electric motor assist only in combination with human propulsion - no throttle
         * mode.
         */
        ...
        public val CombustionDiesel: VehiclePropulsionType =
            VehiclePropulsionType("combustion_diesel")
        ...
        public val HydrogenFuelCell: VehiclePropulsionType =
            VehiclePropulsionType("hydrogen_fuel_cell")
    }
}
