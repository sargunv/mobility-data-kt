...
public data class SystemInformation(
     ...
     *
     * This value is intended to remain the same over the life of the system. Each distinct system
     * or geographic area in which vehicles are operated SHOULD have its own system_id.
     */
    ...
    /**
     * An identifier for a standard license from the
     * [SPDX License List](https://spdx.org/licenses/). Provide license_id rather than license_url
     * if the license is included in the SPDX License List.
     */
...
public data class BrandAssets(
    ...
    /**
     * A fully qualified URL pointing to the location of a graphic file representing the brand for
     * the service.
     *
     * REQUIRED if brand_assets object is defined. File MUST be in SVG V1.1 format and MUST be
    ...
    /**
     * A fully qualified URL pointing to the location of a graphic file representing the brand for
     * the service for use in dark mode applications.
     *
    ...
    /**
     * Color used to represent the brand for the service expressed as a 6 digit hexadecimal color
     * code in the form #000000.
     */
...
public data class RentalAppPlatformUris(
     ...
     *
     * Typically this will be a URI to an app store. REQUIRED if a rental_uris field is populated
     * for this platform.
     */
     ...
     * whether they already have a particular rental app installed. REQUIRED if a rental_uris field
     * is populated for this platform.
     */
