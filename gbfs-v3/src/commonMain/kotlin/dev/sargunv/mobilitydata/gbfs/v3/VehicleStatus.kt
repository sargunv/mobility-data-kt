 ...
 */
@Serializable
public data class VehicleStatus(
    /**
...
) : GbfsFeedData, List<Vehicle> by vehicles
...
public data class Vehicle(
     ...
     *
     * REQUIRED if station_id is not provided for this vehicle (free floating). This field SHOULD
     * have a precision of 6 decimal places (0.000001).
     */
