                ...
                plans =
                    listOf(
                        PricingPlan(
                            ...
                            isTaxable = false,
                            description =
                                mapOf("en" to "Includes 10km, overage fees apply after 10km."),
                            perKmPricing =
                                listOf(
                                    PricingInterval(
                                        start = 10,
                    ...
                    listOf(
                        PricingPlan(
                            ...
                            description =
                                mapOf(
                                    "en" to
                                        "$3 unlock fee, $0.25 per kilometer and 0.50 per minute."
                                ),
                            perKmPricing =
                                listOf(
                                    PricingInterval(
                            ...
                            perMinPricing =
                                listOf(
                                    PricingInterval(start = 0, rate = 0.5, interval = 1, end = null)
                                ),
                        )
                    )
            ),
