...
public data class Fare(
    ...
    /**
     * Array of fare objects defining the price of the service per kilometer. Total cost per rider
     * is the base cost defined in rider, plus the addition of all segments in kilometer, minute,
...
public data class FareEntry(
    /**
     * Interval, in units of the parent key, at which the amount of the row is applied, from start
     * to end.
     */
