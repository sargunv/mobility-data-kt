...
public data class RealtimeBooking(
    ...
    /**
     * The estimated travel time in seconds from the pickup to dropoff location. Cannot be provided
     * if a drop off location is not provided.
     */
    @SerialName("travel_time") public val travelTime: WholeSeconds? = null,
    /**
     * The estimated fare cost of the trip from the pickup to dropoff location. Cannot be provided
     * if a drop off location is not provided.
     */
