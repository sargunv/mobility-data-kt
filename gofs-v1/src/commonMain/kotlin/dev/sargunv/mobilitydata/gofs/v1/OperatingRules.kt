...
public data class OperatingRule(
     ...
     * destination zone until 10:30PM). If end_dropoff_window is provided, start_pickup_window must
     * be provided.
     */
    @SerialName("end_dropoff_window") public val endDropoffWindow: ServiceTime? = null,
    /**
     * Array of calendar IDs from calendars.json defining the dates and days when the pickup and
     * drop off occur.
     */
