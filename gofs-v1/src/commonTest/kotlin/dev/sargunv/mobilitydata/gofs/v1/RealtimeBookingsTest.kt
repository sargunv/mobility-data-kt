                        ...
                        RealtimeBooking(
                            ...
                            bookingDetail =
                                BookingDetail(
                                    serviceName = "Taxi",
                                    androidUri =
                                        "https://www.example.com/app?service_type=REG&platform=android",
                                    iosUri =
                                        "https://www.example.com/app?service_type=REG&platform=ios",
                        ...
                        RealtimeBooking(
                            ...
                            bookingDetail =
                                BookingDetail(
                                    ...
                                    androidUri =
                                        "https://www.example.com/app?service_type=XL&platform=android",
                                    iosUri =
                                        "https://www.example.com/app?service_type=XL&platform=ios",
...
class RealtimeBookingsTest {
    ...
    fun decode() {
        val decodedResponse =
            GofsJson.decodeFromString<GofsFeedResponse<RealtimeBookings>>(jsonContent)
