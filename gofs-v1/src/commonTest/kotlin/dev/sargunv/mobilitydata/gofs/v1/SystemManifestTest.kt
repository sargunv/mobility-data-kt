    ...
    GofsFeedResponse(
        ...
        data =
            SystemManifest(
                "en" to
                    Service(
                        FeedType.SystemInformation to
                            "https://www.example.com/gofs/1/en/system_information",
                        FeedType.Zones to "https://www.example.com/gofs/1/en/zones",
                    ),
                "fr" to
                    Service(
                        FeedType.SystemInformation to
                            "https://www.example.com/gofs/1/fr/system_information",
...
class SystemManifestTest {
    ...
    fun decode() {
        val decodedResponse =
            GofsJson.decodeFromString<GofsFeedResponse<SystemManifest>>(jsonContent)
