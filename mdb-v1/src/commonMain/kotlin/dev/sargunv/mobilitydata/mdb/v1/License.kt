...
/** A catalog license as returned by `GET /v1/licenses`. */
@Serializable
...
/** A catalog license including its rules, as returned by `GET /v1/licenses/{id}`. */
@Serializable
public data class LicenseWithRules(
  /** Unique license identifier, often an SPDX id. */
  public val id: String? = null,
  ...
  /** Permission, condition, and limitation rules. */
